...
public class LendReturnServiceImpl extends ServiceImpl<LendReturnMapper, LendReturn> implements LendReturnService {
    ...
    public void notify(Map<String, Object> paramMap) {
        ...
        //借款人交易流水
        com.atguigu.srb.core.pojo.bo.TransFlowBO transFlowBO = new com.atguigu.srb.core.pojo.bo.TransFlowBO(
                agentBatchNo,
                bindCode,
                totalAmt,
        ...
        lendItemReturnList.forEach(item -> {
            ...
            //投资账号交易流水
            com.atguigu.srb.core.pojo.bo.TransFlowBO investTransFlowBO = new com.atguigu.srb.core.pojo.bo.TransFlowBO(
